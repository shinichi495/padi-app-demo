...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__toc__ = __webpack_require__(2001);
...
var AddonModBookTocPage = /** @class */ (function () {
    ...
    AddonModBookTocPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addon-mod-book-toc',template:/*ion-inline-start:"/Users/namhpham/Project/KMS/paddy/padi-app-mobile/padiapp/src/addon/mod/book/pages/toc/toc.html"*/'<ion-header>\n    <ion-navbar core-back-button>\n        <ion-title>{{ \'addon.mod_book.toc\' | translate }}</ion-title>\n        <ion-buttons end>\n            <button ion-button icon-only (click)="closeModal()" [attr.aria-label]="\'core.close\' | translate">\n                <ion-icon name="close"></ion-icon>\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n<ion-content>\n    <nav>\n        <ion-list>\n            <a ion-item text-wrap *ngFor="let chapter of chapters" (click)="loadChapter(chapter.id)" [class.core-nav-item-selected]="selected == chapter.id">\n                <p [attr.padding-left]="chapter.level == 1 ? true : null">{{chapter.title}}</p>\n            </a>\n        </ion-list>\n    </nav>\n</ion-content>\n'/*ion-inline-end:"/Users/namhpham/Project/KMS/paddy/padi-app-mobile/padiapp/src/addon/mod/book/pages/toc/toc.html"*/
        }),
